...
Enchantment::Enchantment(string name, string description, string type, int cost, int owner, int atk, int def, int actions, string atkDesc, string defDesc): 
    Minion{name, description, type, cost, owner, atk, def, actions}, atkDesc{atkDesc}, defDesc{defDesc} {}
...
int Enchantment::getAttack() const {
    int atk = 0; // needs access to own stats
